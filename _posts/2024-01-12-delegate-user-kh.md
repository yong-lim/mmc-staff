...
![Accept delegated](/assets/img/Delegated_Accept_Kh.jpg "Accept delegate email")

2) របៀបប្តូរទៅគណនីផ្សេងទៀត។ - How to switch to the other account
![Switch user](/assets/img/Delegated_Switch_Kh.jpg "Switch user")

3) តើគណនីផ្សេងទៀតមើលទៅដូចអ្វី - What the other account looks like
![In other user](/assets/img/Delegated_Other_Kh.jpg "In other user")
